...
if __name__ == '__main__':
    ...
    #save_dir='video_dispaly/img4_adv_detc/'
    #save_dir='video_dispaly/img4_pred/'
    #save_dir='./adver_patch_detect/'
    #save_dir='./test_detect/'
    #save_dir='./adv0_repair/'

    #imgfile='video_dispaly/img4_adv_repl_gray' #灰度块替换后的图像
    #save_dir='video_dispaly/img4_adv_repl_gray_pred/'
    #imgfile='/home/zgz/adversarial_samples/adversarial-yolo-master2/10.11_test/img'
    #save_dir='/home/zgz/adversarial_samples/adversarial-yolo-master2/10.11_test/img'
    save_dir='./10.16_test/'
