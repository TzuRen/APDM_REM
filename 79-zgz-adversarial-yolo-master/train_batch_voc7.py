...
class PatchTrainer(object):
    def __init__(self, mode):
        ...
        self.prob_extractor = MaxProbExtractor(12, 20, self.config).cuda()   #voc
    ...
    def train(self):
        ...
        img_path='/home/zgz/pytorch-yolo2-master/my_VOC/12.txt'
        cls_id=12
        ...
        for epoch in range(n_epochs):
           ...
           #         
               ...
               # print('========================success====================')
                ...
                if kk%100==0:
                    finame='gen_adv_darkvoc_12/'+str(12)+'_'+str(epoch)+'_'+str(kk)+'.png'
                    im.save(finame)
