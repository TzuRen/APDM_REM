...
class PatchTrainer(object):
    ...
    def train(self):
        ...
        train_loader = torch.utils.data.DataLoader(InriaDataset3(img_path, max_lab, img_size,shuffle=True),
        ...
        for epoch in range(n_epochs):
            ...
            #for i_batch, (img_batch, lab_batch) in enumerate(train_loader):
                ...
                if kk%100==0:
                    finame='gen_adv_dark_14/'+str(14)+'_'+str(epoch)+'_'+str(kk)+'.png'
                    im.save(finame)
    ...
    def generate_patch(self, type):
        ...
        '''
        img2=Image.open('gen_adv_all6_1/0_124_0.png').convert('RGB')
