...
#        self.img_dir = "inria/Train/pos"
 #       self.lab_dir = "inria/Train/pos/yolo-labels"
        #self.img_dir ='/home/zgz/pytorch-yolo2-master/my_VOC/3'
        #self.lab_dir ='/home/zgz/pytorch-yolo2-master/my_VOC/3_lables'
        #self-test
        #self.img_dir = "inria/Train/test8"
        #self.lab_dir = "inria/Train/test8/yolo-labels"
        
        #self.cfgfile = "cfg/yolov2-tiny.cfg"
        #self.weightfile = "weights/yolov2-tiny.weights"
        self.cfgfile = 'cfg/yolov2-voc.cfg'
        self.weightfile ='/home/zgz/pytorch-yolo2-master/yolov2-voc.weights'
