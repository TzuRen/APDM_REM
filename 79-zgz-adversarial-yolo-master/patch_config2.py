...
class BaseConfig(object):
    ...
    def __init__(self):
        ...
        self.img_dir ='/home/zgz/pytorch-yolo2-master/my_VOC/2'
        self.lab_dir ='/home/zgz/pytorch-yolo2-master/my_VOC/2_lables'
        #self-test
        #self.img_dir = "inria/Train/test8"
        #self.lab_dir = "inria/Train/test8/yolo-labels"
        
        #self.cfgfile = "cfg/yolo.cfg"
        self.cfgfile = 'cfg/yolov2-tiny-voc.cfg'
        #self.weightfile = "weights/yolo.weights"
        self.weightfile ='/home/zgz/pytorch-yolo2-master/yolov2-tiny-voc.weights'
        ...
        self.scheduler_factory = lambda x:optim.lr_scheduler.ReduceLROnPlateau(x, 'min', patience=30)
        self.max_tv = 0
...
class ReproducePaperObj(BaseConfig):
    ...
    def __init__(self):
        ...
        self.loss_target = lambda obj, cls: obj  #就是简单的返回obj ？？
