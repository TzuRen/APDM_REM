...
class PatchTrainer(object):
    def __init__(self, mode):
        ...
        #self.prob_extractor = MaxProbExtractor2(0, 80, self.config).cuda()   #coco
    ...
    def train(self):
        ...
        img_path='/home/zgz/pytorch-yolo2-master/voc_train.txt'
        ...
        for epoch in range(n_epochs):
            ...
            #for i_batch, (img_batch, lab_batch) in enumerate(train_loader):
                ...
                max_conf = self.prob_extractor(output)
                ...
                if kk%100==0:
                    im = transforms.ToPILImage('RGB')(adv_patch_cpu)   
                    finame='gen_adv_all_obj/'+str(epoch//10+10)+'_'+str(epoch+109)+'_'+str(kk)+'.png'
                    im.save(finame)
                ...
                if kk + 1 >= len(train_loader):
                    ...
                    del adv_batch_t, output, max_conf,det_loss, p_img_batch, nps_loss, tv_loss, loss
    ...
    def generate_patch(self, type):
        ...
        '''
        img2=Image.open('gen_adv_all_obj/9_188_700.png').convert('RGB')
