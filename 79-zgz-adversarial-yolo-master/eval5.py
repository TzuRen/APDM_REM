...
# Training settings
datacfg='./cfg/my_voc.data'
#cfgfile='/home/zgz/pytorch-yolo2-master/cfg/yolo-voc.cfg'
cfgfile='./cfg/yolo-voc.cfg'
weightfile='/home/zgz/pytorch-yolo2-master/9.18_my_models_detect/000015.weights'
...
def test():
    ...
    result_file=codecs.open('./9.18_adv_img_test_pred.txt','w')
    #result_file=codecs.open('./14_1433_darkcoco.txt','w')
